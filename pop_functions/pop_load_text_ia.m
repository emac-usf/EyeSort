...
function [EEG, com] = pop_load_text_ia(EEG)
    ...
    geomhoriz = { ...
        ...
        [1 1 1]        % Load config, Load last config buttons + spacer
        1              % Description of Save Intermediate button + spacer
        [1 1 1]        % Save Intermediate button + spacer + spacer
        1              % Parameters from interest area file
        [2.5 0.20]     % RTL reading language checkbox + help button
        ...
        1              % EEG event codes
        [1 1 0.4 1 1 0.35]   % Start Code + End Code on one row
        1              % Use sentence codes checkbox
        [1 1 0.4 1 1 0.35]   % Sentence Start Code + End Code on one row
        ...
        1              % Spacer
        [0.2 0.3 0.2 0.2] % Save config + spacer + Cancel + Confirm
    };

    % Vertical geometry - heights for each row (must match geomhoriz - 30 rows)
    geomvert = [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3];
    ...
    uilist = { ...
        ...
        ...
        {'Style','checkbox','String','Right-to-left reading language','tag','chkRTL','Value',0}, ...
        {'Style','pushbutton','String','?','callback',@(~,~) show_field_help('rtl'),'FontSize',8}, ...
        ...
